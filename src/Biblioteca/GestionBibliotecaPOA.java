 ...
 implements Biblioteca.GestionBibliotecaOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("listarLibros", new java.lang.Integer (3));
    _methods.put ("anadirComentarioYCalificacion", new java.lang.Integer (4));
    _methods.put ("mostrarComentarios", new java.lang.Integer (5));
  }
  ...
  // Devuelve una lista de todos los libros de la biblioteca
       case 3:  // Biblioteca/GestionBiblioteca/listarLibros
       {
         Biblioteca.Libro $result[] = null;
         $result = this.listarLibros ();
         out = $rh.createReply();
  ...
  // Añade un comentario y calificación a un libro
       case 4:  // Biblioteca/GestionBiblioteca/anadirComentarioYCalificacion
       {
         String ISBN = in.read_string ();
         String comentario = in.read_string ();
         float calificacion = in.read_float ();
         boolean $result = false;
         $result = this.anadirComentarioYCalificacion (ISBN, comentario, calificacion);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
  ...
  // Mostrar comentarios de un libro
       case 5:  // Biblioteca/GestionBiblioteca/mostrarComentarios
       {
         String ISBN = in.read_string ();
         String $result[] = null;
         $result = this.mostrarComentarios (ISBN);
         out = $rh.createReply();
         Biblioteca.ListaComentariosHelper.write (out, $result);
         break;
       }
